# Libdragon Makefile (v6): FORCE tool discovery; no accidental host 'cc'
...
showpaths:
	@echo "--- Makefile paths ---"
	@echo "TOOLCHAIN:"; echo "  CC  = $(CC)"
	@echo "TOOLS:"; echo "  n64elfcompress = $(ELFCOMPRESS)"; echo "  n64tool        = $(N64TOOL)"
	@echo "LIBDRAGON:"; echo "  INC     = $(N64_INST)/mips64-elf/include"; echo "  LIBDIR  = $(N64_INST)/mips64-elf/lib"; echo "  LDSCRIPT= $(N64_INST)/mips64-elf/lib/n64.ld"
